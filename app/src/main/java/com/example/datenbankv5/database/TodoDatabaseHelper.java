package com.example.datenbankv5.database;
...
import com.example.datenbankv5.Category;
import com.example.datenbankv5.Priority;
import com.example.datenbankv5.Task;
...
public class TodoDatabaseHelper extends SQLiteOpenHelper {
    ...
    public void insertTask(String id, String task, Category category, String description, Priority priority) {
        SQLiteDatabase db = this.getWritableDatabase();
        try {
            ContentValues values = new ContentValues();
            values.put(COLUMN_ID, id);
            values.put(COLUMN_TASK, task);
            values.put(COLUMN_CATEGORY, category.getName());
