...
public class RestApiServiceTest {
    ...
    private Event event1 = new Event("00000100", "Meeting", Mood.NEUTRAL, Category.WORK, LocalDateTime.of(2025,1,13, 12, 30), LocalDateTime.of(2025,1,13, 14, 00), Duration.ofMinutes(90), "C646", null, "Meeting about our App", null );

    private Event event2 = new Event("00000101", "Fußball", Mood.HAPPY, null, LocalDateTime.of(2025,1,11, 17, 30), LocalDateTime.of(2025,1,11, 20, 00), Duration.ofMinutes(15), "SEP", RepetitionType.WEEKLY, null, null );

    private Event event3 = new Event("00000102", "Date", Mood.EXCITED, null, LocalDateTime.of(2025,1,17, 15, 00), LocalDateTime.of(2025,1,17, 22, 00),null, null, null, "Weihnachtsmarkt und Abfahrt", null );

    private Event event4 = new Event("00000103", "Arzttermin", Mood.SAD, null, LocalDateTime.of(2025,2,2, 8, 25), LocalDateTime.of(2025,2,2, 8, 45), Duration.ofMinutes(5), "Ärztehaus II", null, "nüchtern!", null );

    private Event event5 = new Event("00000104", "Vorlesung", Mood.CALM, Category.UNIVERSITY, LocalDateTime.of(2025,1,13, 12, 15), LocalDateTime.of(2025,1,13, 13, 45), Duration.ofMinutes(90), "C446", RepetitionType.WEEKLY, "Prog3", null );
